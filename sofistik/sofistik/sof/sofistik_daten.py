...
class CREC_ITEM_STRU(Structure):  #        Names of the structure elements
    _fields_ = [('m_name', c_int * 2), ('m_dim', c_int), ('m_type', c_int), ('m_dim1', c_int)]
...
class CREC_MIX_MIXI(Structure):  #        Mixinfo
    _fields_ = [('m_typ', c_int), ('m_keytyp', c_int), ('m_mixfrom', c_int)]
...
class CMAT_USER(Structure):  # 1/NR:10??  Information on user input
    _fields_ = [('m_id', c_int), ('m_bit', c_int * 32)]  #        Identification  #        User input for 001/NR:1
...
class CSECT_MAT(Structure):  # 9/NR:91  SectionalMaterial list
    _fields_ = [('m_id', c_int), ('m_mat', c_int * 31)]  #        Identification = 91  #        material numbers
...
class CSYST_COM_ACT(Structure):  #        Identifier of action
    _fields_ = [('m_id', c_int), ('m_faku', c_float), ('m_fakf', c_float)]
...
class CLC_LRES_LC(Structure):  #        load case number and factor (dynamic length)
    _fields_ = [('m_n', c_int), ('m_f', c_float)]
...
class CLC_POIN_LPT(Structure):  #        loadpt
    _fields_ = [('m_p', c_float), ('m_x', c_float), ('m_y', c_float), ('m_z', c_float)]  # [1001]  # [1001]  # [1001]
...
class CLC_DAMP(Structure):  # 13/LC:1  Damping values
    _fields_ = [('m_id', c_int), ('m_d', c_float * 7)]  #        identifier 1  #        modal damping values
...
class CACT_TASK_SCOM(Structure):  #        index,factor and name of items
    _fields_ = [('m_ind', c_int), ('m_fak', c_float), ('m_bez', c_int)]
...
class CCSG_CSYS(Structure):  # 15/-13  System specification
    _fields_ = [('m_ics', c_int), ('m_prob', c_int)]  #        corresponding cs number  #        problem type
...
class CCSG_CGW(Structure):  # 15/-15  Change ground water level
    _fields_ = [('m_ics', c_int), ('m_hw', c_float)]  #        corresponding cs number  # [  13] new ground water level
...
class CVIEW_SEL_R(Structure):  #        Range lower and upper limit
    _fields_ = [('m_low', c_int), ('m_upp', c_int)]
...
class CNODE_GRC(Structure):  # 20/11:0  number of Nodegroups
    _fields_ = [('m_id', c_int), ('m_maxgrp', c_int)]  #        maximum number of groups per node
...
class CNODE_KIG_ID(Structure):  #        node+degree-number of dependent (0)
    _fields_ = [('m_nr', c_int), ('m_nd', c_int)]
...
class CNODE_KIG(Structure):  # 21/00:*99  general constraints (equation list)
    _fields_ = [('m_ktl', c_int), ('m_id', CNODE_KIG_ID * 256)]  #        node+degree-number of dependent (0)
...
class CGPT_CON_M(Structure):  #        connected members
    _fields_ = [('m_nelt', c_int), ('m_nrel', c_int), ('m_node', c_int), ('m_narb', c_int), ('m_x', c_float)]  # [1001]
...
class CGPT_DADS(Structure):  # 30/NR:998  List of origin ids the structural member has been created from
    _fields_ = [('m_id', c_int), ('m_idd', c_int * 63)]  #        ident 998  #        ids of all anchestors
...
class CGAR_REF(Structure):  # 32/NR:-  Reference to another Geometry
    _fields_ = [('m_igm', c_int)]  #        negative value of the master geometry
...
class CHIST_HED(Structure):  # 80/LC:-10?  TimeHistoryTitle
    _fields_ = [('m_rid', c_float), ('m_title', c_int * 33)]  #        Identifier of history type  #        Designation
...
class CHIST_ITEM(Structure):  #        History element
    _fields_ = [('m_nr', c_int), ('m_typ', c_int)]
...
class CHIST_VAL(Structure):  # 80/LC:+  Transient data
    _fields_ = [('m_tt', c_float), ('m_vb', c_float * 32)]  #        Time/frequency  #        curve values
...
class CBOUN_LC_LPT(Structure):  #        node number + load value
    _fields_ = [('m_n', c_int), ('m_p', c_float)]
...
class CRSET_DAT(Structure):  # 188/LC  Result-values for sets of results
    _fields_ = [('m_id', c_int), ('m_val', c_float * 255)]  #        identifier of result set  #        result values
...
class CQUAD_LAI_LPT(Structure):  #        load points in local coordinates
    _fields_ = [('m_s', c_float), ('m_t', c_float), ('m_p', c_float)]
...
class CQUAD_LT(Structure):  # 206/NR  Temperature load profiles for QUADs
    _fields_ = [('m_t', c_float), ('m_temp', c_float * 20 * 5)]  # [  90] Time value  #        Temperature values
...
class CQUAD_STP_HTYP(Structure):  #        = state variables for nonlinear material
    _fields_ = [('m_id', c_int), ('m_idim', c_int), ('m_maxval', c_float)]
...
class CQUAD_SEQ(Structure):  # 229/LC:-  location of sectional results in master
    _fields_ = [('m_nr', c_int), ('m_x', c_float)]  #        negative beam number  # [1001] section along beam
